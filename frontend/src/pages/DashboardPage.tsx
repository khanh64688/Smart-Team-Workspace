  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Project Analytics</h1>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Dự án hiện chưa có công việc nào để phân tích. Tạo công việc mới trên bảng Kanban để xem biểu đồ thống kê."
        />
      ) : (
        <>
          {/* Top Stat Cards */}
