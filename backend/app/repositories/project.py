...
class ProjectRepository:
    ...
    def membership(self, project_id: str, user_id: str | uuid.UUID) -> ProjectMember | None:
        import uuid
    ...
    def list(self, user_id: str | uuid.UUID, is_admin: bool, q: str | None, status: ProjectStatus | None, page: int, size: int, sort: str):
        import uuid
