...
class TaskInsightsRepository:
    """
    Truy vấn task phục vụ chatbot và dashboard.

    Tách khỏi `TaskRepository` (repositories/task.py) vì repo kia lo CRUD
    cho API task, còn các method ở đây chỉ đọc và luôn nhận project_id —
    không có đường nào lấy task mà không nêu rõ dự án. Việc kiểm tra
    người gọi có thuộc dự án hay không là của tầng service.
    """
...
__all__ = ["TaskInsightsRepository", "now_utc"]
